...
type Job = { id?: string; title: string; company: string; location: string; description: string; url: string; salary: string | null; posted: string | null; source?: string; savedAt?: string };
type SavedJobsResult = { jobs?: Job[]; page?: number; totalPages?: number; total?: number; error?: string };
